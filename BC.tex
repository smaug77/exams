...
% Section 4.7
% This is: 1993 AP Calculus BC Section I Problem 3
...
% 1995 Calculus BC Section II problem 3
\question (\totalpoints\ points) As shown in the figure below, water
     ...
     \begin{parts}
     \part[5] Write an expression for the volume of water in the
     conical tank as a function of $h$
     \begin{solution}
         $$\frac{r}{h} = \frac{4}{12} = \frac{1}{3},\ r
         = \frac{1}{3}h$$
         $$V = \frac{1}{3}\pi(\frac{1}{3}h)^2 h = \frac{\pi h^3}{27}$$        
     \end{solution}
     \part[5] At what rate is the volume of water in the conical tank
     changing when $h = 3$? Indicate units of measure.
     \begin{solution}
         $$\frac{dV}{dt} = \frac{\pi h^2}{9} \frac{dh}{dt}$$
         $$= \frac{\pi h^2}{9} (h - 12) = -9\pi$$
         $V$ is decreasing at $9 \pi$ ft$^3$ / min.
     \end{solution}
     \part[5] Let $y$ be the depth, in feet, of the water in the
         cylindrical tank. At what rate is $y$ changing when $h = 3$?
         Indicate units of measure.
     \begin{solution}
         Let $W$ be the volume of the water in cylindrical tank. 
...
% 1995 Calculus BC Section II problem 5
\question (\totalpoints\ points) Let $f(x) = x^2$, $g(x) = \cos x$,
      and $h(x) = x^2 + \cos x$. From the graphs of $f$ and $g$ shown
      below, you might think that the graph of $h$ should look like
      the third graph.
      \begin{center}
          \includegraphics{BCII-5i.png}
      \end{center}

      \begin{parts}
      \part[3] Sketch the actual graph of $h$ in the viewing window
               provided below (using a graphing calculator).
      \begin{solution}
          \begin{center}
              \includegraphics{BCII-5ii.png}
          \end{center}
      \end{solution}
      \part[6] Use $h''(x)$ to explain why the graph of $h$ does not
      look like the graph in the third figure.
      \begin{solution}
          $$h'(x) = 2x - \sin x;\ h''(x) = 2 - \cos x$$
          $2 - \cos x > 0$ for all $x$, so graph must be concave up
          everywhere.
      \end{solution}
      \part[6] Prove that the graph of $y = x^2 + \cos(kx)$ has either
          no points of inflection or infinitely many points of
          inflection, depending on the value of the constant $k$.
      \begin{solution}
          $$y''(x) = 2 - k^2 \cos (kx)$$
          If $k^2 \le 2$, $y'' \ge 0$ for all $x$, so no inflection
          points. \
          If $k^2 > 2$, $y''$ changes sign and is periodic, so changes
          sign infinitely many times. Hence there are infinitely many
          inflection points.
      \end{solution}
      \end{parts}
